...
@pytest.mark.parametrize('x,f,expected', [
    ...
    ([[2, 3], [5, 7]], lambda x: det(matrix_power(x, 2)), [[-14.000015258789062, 10.000007629394531], [5.999988555908203, -3.9999847412109375]]),
    ([[1, 2], [3, 4]], compose(exp, det), [[0.5413411855697632, -0.4060058891773224], [-0.2706705927848816, 0.1353352963924408]])
])
